<template>
  <div class="flex flex-col flex-grow q-pa-md">
    <div>
      ...
      <p class="mt-3">
        Enter IPV4 address and Port number of POS system.
      </p>

      <p><strong>Why This Information Matter:</strong></p>
      <p>
        <span>This IP address and Port number is required to connect your customer display to the POS system.</span><span> Having this correctly configured will streamline customer display and POS system communication.</span>
      </p>
      <p>
      ...
      <ul class="mb-6 ml-6 list-decimal space-y-2">
        <li>
          <span>If you're unsure about IPV4 address and Port number,</span><span>
        ...
        <li>
          <span>Once configured,</span><span>
            this information typically won't need to be changed unless you're switching locations or managing multiple
            restaurants.</span>
        </li>
      </ul>
      <p>
...
const onSubmit = () => {
  ...
  localStorage.setItem('localSocketServerPort', String(portNumber.value))
  connectSocket(ipAddress.value, portNumber.value, router)
}
</script>
